  ...
  <el-container style="border:1px solid #eee;" direction="vertical">
    <el-row>
      <el-col :span="24">
        ...
        <el-table v-loading="loading" element-loading-text="别着急，重要的数据可以多等等" :data="totalA" stripe border fit highlight-current-row style="width: 95%; font-size:12px;">
          <el-table-column align="center" label="序号"  width="65" type="index" />
          <el-table-column width="150px" align="center" label="日期" header-align="center" prop="price_dt" />
    ...
    <el-row>
      <el-col :span="24">
        <el-table v-loading="loading" element-loading-text="别着急，重要的数据可以多等等" :data="industryValue" stripe border fit highlight-current-row style="width: 95%; font-size:12px;">
          <el-table-column align="center" label="序号" width="65" type="index" />
          <el-table-column width="150px" align="center" label="行业代码" header-align="center" prop="bond_id" />
          <el-table-column width="150px" align="center" label="行业名称" header-align="center" prop="bond_nm" />
          <el-table-column width="80px" align="center" label="PE" sortable header-align="center" prop="price" />
          <el-table-column width="180px" align="center" label="PE温度" sortable header-align="center" prop="increase_rt" />
          <el-table-column width="80px" align="center" label="PB" header-align="center" prop="stock_nm" />
          <el-table-column width="180px" align="center" label="PB温度" sortable header-align="center" prop="sprice" />
          <el-table-column width="200px" align="center" label="股票数" sortable header-align="center" prop="sincrease_rt" />
          <el-table-column width="200px" align="center" label="亏损股票数" sortable header-align="center" prop="sincrease_rt" />
          <el-table-column width="200px" align="center" label="股票" sortable header-align="center" prop="sincrease_rt" />
        </el-table>
      </el-col>
    </el-row>
  </el-container>
