...
def MASystem():
    ...
    for stock in stockList:
        ...
        if price > ma20 and ma20 > ma5 and ma5 > ma10:
            ...
            infoDic = {'opt':'buy', 'vol':'0.3', 'code':stockInfo[1], 'name':stockInfo[2], 'price':price, 'HY': stockInfo[4], 'dynamicPE':stockInfo[6], 
                    'PE':stockInfo[5],'PB':stockInfo[7], '5Cost':data.at[lastIndex-5,'close'], '10Cost':data.at[lastIndex-10,'close'], 
